...
<div class="relative flex flex-col gap-4 pb-6 overflow-x-clip">
  ...
  <div class="grid grid-cols-1 items-start gap-4">
    ...
    <form method="POST" action="/user/updateMe" class="col-span-1 md:col-span-1 flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <div class="grid sm:grid-cols-[1fr_1fr] md:grid-cols-[1fr_1fr_1fr] gap-2.5">
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <input type="text" name="profile_picture_url" id="profile_picture_url"
                placeholder="Nhập đường dẫn hình ảnh" required class="base-input-sm"
                value="<?= $_SESSION['user']['profile_picture_url'] ?>">
            </div>
          </div>
        </div>
      </div>
