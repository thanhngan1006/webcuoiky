...
<?php require base_path('views/partials/headerNewSalePerson.php') ?>
  ...
  <div class="flex flex-col gap-5 p-5 bg-white rounded-sm border border-neutral-5 shadow overflow-hidden items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md p-5  rounded-sm border border-neutral-5 shadow overflow-hidden">
      ...
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Đổi mật khẩu</h2>
      </div>

      <!-- Centered form -->
      <form method="POST" action="/user/changepwsale" class="space-y-5 mt-6">
        ...
        <div class="flex items-center justify-start gap-2">
          <input type="checkbox" onclick="show2Password()">Hiện mật khẩu
        </div>
