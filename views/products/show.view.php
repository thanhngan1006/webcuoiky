...
<div class="flex flex-col gap-4">
  <div class='flex items-center gap-1.5'>
    ...
    <span class='font-semibold text-lg'>Xem sản phẩm</span>
  </div>
  <div class="flex flex-col gap-5 p-5 bg-white rounded-sm border border-neutral-5 shadow overflow-hidden">
    <div class="container mx-auto ">
      <div class="max-w-lg mx-auto">

        <form method="PATCH" action="/product">
          <div class="space-y-12">

            <div class=" pb-4">
              <h2 class="text-base font-semibold leading-7 text-gray-900 mb-8">Xem thông tin sản phẩm</h2>
              ...
              <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                  ...
                  <div class="mt-2">
                    <input type="text" name="name" id="name" autocomplete="name" class=" px-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="<?= $product['name']  ?>" disabled>
                  </div>
