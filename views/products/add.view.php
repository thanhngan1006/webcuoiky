...
<div class="flex flex-col gap-4">
  <div class='flex items-center gap-1.5'>
    ...
    <span class='font-semibold text-md'>Thêm sản phẩm</span>
  </div>
      ...
      <div class="max-w-lg mx-auto">
        ...
        <form method="POST" action="/products">
            ...
            <div class=" pb-4">
              ...
              <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                  ...
                  <div class="mt-2">
                    <input type="text" name="name" id="name" autocomplete="name" class=" px-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="<?= isset($_POST['name']) ? $_POST['name'] : '' ?>">
                  </div>
          ...
          <div class="mt-6 flex items-center justify-end gap-x-6">
            <button type="button" class="text-sm font-semibold leading-6 text-gray-900 border border-gray-300 rounded-md px-3 py-2 hover:border-gray-500"><a href="/products">Cancle</a></button>
