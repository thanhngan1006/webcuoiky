...
<header class="fixed w-full z-30 flex bg-white p-2 items-center justify-center h-16 px-10 shadow">
  ...
  <div class="flex relative ">
    ...
    <div id="subMenu" class="sub-menu-wrap">
      <div class="sub-menu" style="background: #fff; width:100%; padding:10px; margin: 10px 0px 10px 0px;">
        <div class="user-info" style="display:flex; align-items:start; flex-direction:column">
          <a href="/user" class="sub-menu-link">Thông tin cá nhân</a>
          <hr style="border:0 ; height:1px ; width: 100%; background: #ccc; margin:6px 0 8px;">
          <a href="/user/changepassword" class="sub-menu-link">Đổi mật khẩu</a>
        </div>
      </div>
    </div>
  </div>
