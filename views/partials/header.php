    ...
    <div class="flex gap-x-3 items-center px-3">
      <div class="flex-none flex justify-center">
        <div class="w-8 h-8 flex rounded-full overflow-hidden">
          <img
            src="https://images.fpt.shop/unsafe/filters:quality(5)/fptshop.com.vn/uploads/images/tin-tuc/175421/Originals/avatar-la-gi-2.jpg" />
        </div>
      </div>
...
<div id="toast"
  class="self-end fixed z-50 top-20 -right-96 w-max px-2 py-3 bg-white rounded-lg transition-all duration-300 border border-l-4  border-common-success">
  <div class="flex items-center gap-2">
    <svg class="w-5 h-5 text-common-success" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
      viewBox="0 0 20 20">
      <path
